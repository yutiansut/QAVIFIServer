...
with io.open('qavifiserver/__init__.py', 'rt', encoding='utf8') as f:
    context = f.read()
...
URL = "https://github.com/yutiansut/qavifiserver"
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'qavifiserver=qavifiserver.__init__:run_server',
        ]
    },
